    ...
    return (
        <div>
            <div className='w-75 mx-auto border p-4 mt-4 bg-white shadow'>
                ...
                <p className='fs-5'><strong>Authentication:</strong><br /> Authentication verifies who the user is.Authentication works through passwords, one-time pins, biometric information, and other information provided or entered by the user.Authentication is the first step of a good identity and access management process.Authentication is visible to and partially changeable by the user.</p>
                <p className='fs-5'><strong>Authorization:</strong><br /> Authorization determines what resources a user can access.Authorization works through settings that are implemented and maintained by the organization.Authorization always takes place after authentication.Authorization isn’t visible to or changeable by the user.</p>
            </div>
            <div className='w-75 mx-auto border p-4 mt-4 bg-white rounded shadow'>
            ...
            <div className='w-75 mx-auto border p-4 mt-4 bg-white rounded mb-4 shadow'>
